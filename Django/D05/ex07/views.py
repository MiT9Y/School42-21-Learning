...
def insert(request):
    ...
    return render(request, 'ex07/templates/insert.html', {'res': res})
...
def update(request):
    ...
    try:
        ...
        form = 0
    return render(request, 'ex07/templates/update.html', {'form':form})
